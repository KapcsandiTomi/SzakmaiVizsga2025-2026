...
<body>
    <div class="container">
        ...
        <?php else: ?>
            ...
            <div class="footer">
                ...
                <p>Need assistance? Email: <strong>kapcsandi.tomi@gmail.com</strong> or call: <strong>+36 70 645 1793</strong></p>
            </div>
        <?php endif; ?>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Ha volt kupon alkalmazva, mutassuk
