                    ...
                    try {
                        ...
                        $mail->Body .= '
                                    ...
                                    <div class="footer">
                                        ...
                                        <p>📧 Email: <a href="mailto:kapcsitomo2022@gmail.com">kapcsitomo2022@gmail.com</a></p>
                                        <p>📞 Phone: +36 70 645 1793</p>
                                        <p>🏪 Aqua Mini Shop</p>
...
<body>
    <div class="container">
        ...
        <?php else: ?>
            ...
            <div class="footer">
                <p>© <?= date('Y') ?> Aqua Mini Shop. All rights reserved.</p>
                <p>Need assistance? Email: <strong>kapcsitomo2022@gmail.com</strong> or call: <strong>+36 70 645 1793</strong></p>
            </div>
        <?php endif; ?>
