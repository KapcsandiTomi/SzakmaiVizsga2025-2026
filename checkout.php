...
<div class="checkout-container">
    ...
    <div class="grid">
        ...
        <div>
            <!-- HIBAMEZŐ -->
            <div id="validationError" class="error-message" style="display: none; margin-bottom: 15px;">
                <div class="alert alert-danger" role="alert" id="validationErrorMessage"></div>
            </div>
            ...
            <form method="POST" id="checkoutForm" novalidate>
                ...
                <div class="input-container">
                    ...
                    <input id="fullname" name="fullname" class="form-control" required value="<?= htmlspecialchars($_SESSION['name'] ?? '') ?>">
                    <div id="fullnameError" class="error-text"></div>
                </div>

                <div class="input-container">
                    <label for="email">Email Address *</label>
                    <input id="email" name="email" type="email" class="form-control" required value="<?= htmlspecialchars($_SESSION['email'] ?? '') ?>">
                ...
                <div class="payment-box">
                    ...
                    <div style="margin-top:10px;">
                        <div class="form-check">
                            ...
                            <label class="form-check-label small-muted" for="terms" id="termsLabel">
...
function clearAllErrors() {
    const fields = ['fullname', 'email', 'address', 'card_type', 'card_number', 'expiry', 'cvv', 'terms'];
...
if (applyCouponBtn && couponInput) {
    applyCouponBtn.addEventListener('click', function(e){
        ...
        if (!code) { 
            showValidationError('Enter a coupon code!');
            return; 
        }
        ...
        if (!known[code]) {
            showValidationError('Unknown coupon code.');
            return;
        }
        ...
        updateSummary();
        showValidationError('Coupon applied successfully!');
        const errorDiv = document.getElementById('validationError');
        if (errorDiv) {
            errorDiv.querySelector('.alert').className = 'alert alert-success';
        }
    });
}
...
if (form && payBtn) {
    form.addEventListener('submit', function(e){
        ...
        if (!cardType) {
            showFieldError('card_type', 'Please select a Card Type');
            hasError = true;
        }
        
        if (!/^\d{12}$/.test(cardVal)) {
            showFieldError('card_number', 'Card number must be exactly 12 digits');
            hasError = true;
        }
        ...
        if (!/^(0[1-9]|1[0-2])\/\d{2}$/.test(expiryVal)) {
            showFieldError('expiry', 'Invalid expiry format. Please use MM/YY');
            hasError = true;
        }
        
        if (!terms) {
            showFieldError('terms', 'You must accept the Terms & Conditions and Privacy Policy');
            hasError = true;
        }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Real-time validáció
    const fieldsToValidate = ['fullname', 'email', 'address', 'card_type'];
