...
<head>
    ...
    <title>White Shark WAKIZASHI 2 US Gray/Black</title>
      ...
      <div class="card__body">
        <div class="half">
          <div class="featured_text">
            <h1>Keyboard</h1>
            <p class="sub">White Shark WAKIZASHI 2 US Gray/Black</p>
            <p class="price">$32</p>
          </div>
          <div class="image">
        ...
        <div class="half">
          <div class="description">
            <p>The <strong>White Shark WAKIZASHI 2 US Gray/Black</strong> is a durable and stylish membrane gaming keyboard designed for comfort, precision, and reliability. 
            With vivid RGB lighting, responsive keys, and a spill-resistant build, it is ideal for both gaming and daily use.</p>
            <br>
            <ul>
              ...
              <li><b>Features:</b> Spill-resistant construction</li>
      ...
      <div class="card__footer">
        ...
        <div class="action">
          <form action="../add_to_cart.php" method="POST">
            <input type="hidden" name="product_name" value="White Shark WAKIZASHI 2 US Gray/Black">
            <input type="hidden" name="product_price" value="32">
