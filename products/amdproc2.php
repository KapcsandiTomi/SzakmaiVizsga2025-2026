...
<head>
    ...
    <title>AMD Ryzen™ 9 9900X3D</title>
      ...
      <div class="card__body">
        <div class="half">
          <div class="featured_text">
            <h1>Processor</h1>
            <p class="sub">AMD Ryzen™ 9 9900X3D</p>
            <p class="price">$699</p>
          </div>
          <div class="image">
        ...
        <div class="half">
          <div class="description">
            <p>The <b>AMD Ryzen™ 9 9900X3D</b> is engineered for high-performance gaming and demanding workloads. Featuring 3D V-Cache technology, it delivers extraordinary gaming performance and multitasking efficiency.</p>
            <br>
            <p><ul>
                <li><b>Cores / Threads:</b> 12 / 24</li>
                <li><b>Base / Boost Clock:</b> 3.8 GHz / 4.9 GHz</li>
