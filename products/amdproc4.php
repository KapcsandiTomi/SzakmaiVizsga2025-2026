      ...
      <div class="card__body">
        <div class="half">
          <div class="featured_text">
            <h1>Processor</h1>
            <p class="sub">AMD Ryzen™ 9 9950X</p>
            <p class="price">$749</p>
          </div>
          <div class="image">
        ...
        <div class="half">
          <div class="description">
            <p>The <b>AMD Ryzen™ 9 9950X</b> is built for extreme performance in gaming and professional applications. With multiple cores, high clock speeds, and ample cache, it delivers fast and reliable computing for demanding workloads.</p>
            <br>
            <p><ul>
                <li><b>Cores / Threads:</b> 16 / 32</li>
                <li><b>Base / Boost Clock:</b> 3.5 GHz / 5.0 GHz</li>
                <li><b>Cache:</b> 72 MB (L2 + L3)</li>
