...
<head>
    ...
    <title>Intel Core i5-14400</title>
      ...
      <div class="card__body">
        <div class="half">
          <div class="featured_text">
            <h1>Processor</h1>
            <p class="sub">Intel Core i5-14400</p>
            <p class="price">$280</p>
          </div>
          <div class="image">
        ...
        <div class="half">
          <div class="description">
            <p>The <b>Intel Core i5-14400</b> provides reliable performance for everyday computing, gaming, and light content creation. With balanced cores and efficient power usage, it delivers smooth multitasking and responsive performance.</p>
            <br>
            <p><ul>
