...
class CheckoutHandler {
    ...
    private function generateAdminEmailBody($orderId, $customerData, $totals) {
        ...
        ' . $couponInfo . '
        <br>
        <a href="' . ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off') ? 'https' : 'http') . '://' . ($_SERVER['HTTP_HOST'] ?? 'localhost') . '/Szakmai/admin/index.php?page=orders" style="background: #00796b; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">View Order in Admin Panel</a>';
    }
