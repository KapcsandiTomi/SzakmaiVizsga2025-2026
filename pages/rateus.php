...
require_once __DIR__ . '/../handler/ratedata.php';
require_once __DIR__ . '/../handler/ratehandler.php';
...
$loggedInUserName = trim($_SESSION['name'] ?? '');
        ...
        <form method="POST" id="reviewForm">
            <div class="form-group">
                ...
                <input type="text" id="user_name" name="user_name" class="form-control" 
                       placeholder="Your registered name" disabled 
