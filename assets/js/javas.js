...
document.addEventListener('DOMContentLoaded', function () {
    ...
    card.innerHTML = '<div style="font-size:40px;line-height:1;margin-bottom:10px;">🔒</div>' +
        ...
        '<p style="margin:0 0 18px 0;color:#475569;font-size:16px;">Are you sure you want to logout?</p>' +
        '<div style="display:flex;gap:10px;justify-content:center;">' +
        '<button type="button" id="logoutCancelBtn" style="padding:10px 16px;border:1px solid #cbd5e1;background:#fff;color:#0f172a;border-radius:10px;font-weight:600;cursor:pointer;">Cancel</button>' +
        '<button type="button" id="logoutConfirmBtn" style="padding:10px 16px;border:none;background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;border-radius:10px;font-weight:700;cursor:pointer;">Logout</button>' +
        '</div>';
