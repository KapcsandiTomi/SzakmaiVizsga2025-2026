...
if (!isset($_SESSION['email'])) {
    header("Location: /Szakmai/index.php");
    exit();
}
...
if (empty($order_list)) {
    header("Location: /Szakmai/pc_builder/");
    exit();
}
            ...
            try {
                ...
                if ($stmt->execute()) {
                    ...
                    try {
                        ...
                        <br>
                        <a href="' . ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off') ? 'https' : 'http') . '://' . ($_SERVER['HTTP_HOST'] ?? 'localhost') . '/Szakmai/admin/index.php?page=orders" style="background: #00796b; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">View PC Build in Admin Panel</a>
                        ';
...
<body>
    <div class="main-container">
        <div class="checkout-container">
            <?php if ($success): ?>
                <div class="success-box">
                    ...
                    <div class="action-buttons">
                        <a href="/Szakmai/products.php" class="btn btn-primary">Continue Shopping</a>
                        <a href="/Szakmai/pc_builder/" class="btn btn-outline">Build Another PC</a>
                    </div>
            ...
            <?php else: ?>
                <a href="/Szakmai/pc_builder/" class="back-btn">← Back to Configurator</a>
                        ...
                        <form method="POST" id="checkoutForm">
                            ...
                            <div class="terms-check">
                                ...
                                <label class="terms-label" for="terms">
                                    I agree to the <a href="/Szakmai/pages/terms.php" target="_blank">Terms & Conditions</a> 
                                    and <a href="/Szakmai/pages/privacy.php" target="_blank">Privacy Policy</a>. *
                                </label>
