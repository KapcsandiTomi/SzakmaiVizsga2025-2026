            ...
            try {
                ...
                if ($stmt->execute()) {
                    ...
                    try {
                        ...
                        <br>
                        <a href="http://localhost/Szak/admin/orders.php?id=' . $orderId . '" style="background: #00796b; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">View PC Build in Admin Panel</a>
                        ';
...
<head>
    ...
    <link rel="stylesheet" href="/Szak/pc_builder/assets/css/style.css">
    <link rel="icon" href="/Szak/letoles.jpg" type="image/png">
    <style>
        :root {
            --primary: #00796b;
            --primary-dark: #004d40;
...
<body>
    <div class="main-container">
        <div class="checkout-container">
            <?php if ($success): ?>
                <div class="success-box">
                    ...
                    <div class="action-buttons">
                        <a href="/Szak/products.php" class="btn btn-primary">Continue Shopping</a>
                        <a href="/Szak/pc_builder/" class="btn btn-outline">Build Another PC</a>
                    </div>
            ...
            <?php else: ?>
                <a href="/Szak/pc_builder/" class="back-btn">← Back to Configurator</a>
                        ...
                        <form method="POST" id="checkoutForm">
                            ...
                            <div class="terms-check">
                                ...
                                <label class="terms-label" for="terms">
                                    I agree to the <a href="/Szak/terms.php" target="_blank">Terms & Conditions</a> 
                                    and <a href="/Szak/privacy.php" target="_blank">Privacy Policy</a>. *
                                </label>
