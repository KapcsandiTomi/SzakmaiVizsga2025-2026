...
<head>
    ...
    <style>
        body { font-family: Inter, Arial, sans-serif; background:#f5f8fb; color:#1f3342; margin:0; padding:20px; }
...
<body>
    <div class="wrap">
        ...
        <h2>9. Contact</h2>
        <p>If you have questions about these Terms, please contact us at <strong>kapcsandi.tomi@gmail.com</strong>.</p>
